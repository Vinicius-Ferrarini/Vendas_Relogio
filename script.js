// script.js (OTIMIZADO + SKELETON + ID ESTÁVEL - FILTRO SANFONA CORRIGIDO)
...
async function loadAndRender(){
    ...
    filtroCategoria.addEventListener('change', filtrarEExibirProdutos);
    ...
    // ==============================================
    // CORREÇÃO DO BUG DO ÍCONE DUPLICADO
    // ==============================================
    if (toggleFiltersButton) {
        toggleFiltersButton.addEventListener('click', () => {
            ...
            if (isVisible) {
                ...
                // CORRIGIDO: Só muda o texto, não adiciona o ícone de novo
